...
using namespace std;
enum class Opciones {
    Agregar = 1, Remover , Mostrar, buscar, Listar, Editar, MejoresTotal, MejoresTipo};
...
void Menu::mostrarMenu() {
    ...
    cout << "6. Mostrar Objetos\n";
    cout << "7. Mostrar top 3 de establecimientos\n";
    cout << "8. Mostrar top 3 Hoteles, Restaurantes o Museos\n";
    cout << "0. Para Salir\n\n";
}
...
//            agregarObjeto();
//            break;
//            Trabajo was compiled with optimization - stepping may behave oddly; variables may not be available
//            break;
